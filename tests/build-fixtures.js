...
const exp = "module.exports={norm,near1,findNear,restoreNames,fakeName,gender,origin,POOL,STOP,PLACE_BY,Engine,ckey,variants,hord,words,pseudoRX,hash32,discover,anchored,partName,ctxHTML,findPlaces,esc,GF,GM,bodyNames,nameish,VRB,COMMON,nerClean,nerChunks,PUBLIC_ORG,nerAlign,nerGroup,fixTokJSON,rxClean,geoNames,placesFound,examplesOf,fakePlace,PAT,fakeOrg,orgHead,GROUP_HEADS,ORG_HEADS,PLACES,ATLAS_TAGS,ATLAS_KEYS,ATLAS_VOCAB,atlasTags,atlasPenalty,atlasDiff,placeKind,NEIGHBORHOODS,STREETS,geoMap}";
