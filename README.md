...
|---|---|---|---|
| `index.html` | 908 | `<div id="ver">גרסה v32</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 106 | `console.log("… גרסה v32")` | שורת הפתיחה בקונסול |
| `index.html` | 144 | `if(served==="v32") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 146 | `el.innerHTML='גרסה v32 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v32";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v32 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
