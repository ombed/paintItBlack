...
|---|---|---|---|
| `index.html` | 763 | `<div id="ver">גרסה v16</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 95 | `console.log("… גרסה v16")` | שורת הפתיחה בקונסול |
| `index.html` | 133 | `if(served==="v16") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 135 | `el.innerHTML='גרסה v16 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v16";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v16 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
