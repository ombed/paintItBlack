...
|---|---|---|---|
| `index.html` | 1133 | `<div id="ver">גרסה v46</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v46")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v46") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v46 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v46";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v46 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
