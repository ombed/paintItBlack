...
|---|---|---|---|
| `index.html` | 807 | `<div id="ver">גרסה v23</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 96 | `console.log("… גרסה v23")` | שורת הפתיחה בקונסול |
| `index.html` | 134 | `if(served==="v23") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 136 | `el.innerHTML='גרסה v23 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v23";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v23 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
