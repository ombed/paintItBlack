...
|---|---|---|---|
| `index.html` | 751 | `<div id="ver">גרסה v13</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 94 | `console.log("… גרסה v13")` | שורת הפתיחה בקונסול |
| `index.html` | 132 | `if(served==="v13") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 134 | `el.innerHTML='גרסה v13 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v13";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v13 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
