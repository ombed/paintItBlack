...
|---|---|---|---|
| `index.html` | 1133 | `<div id="ver">גרסה v47</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v47")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v47") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v47 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v47";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v47 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
