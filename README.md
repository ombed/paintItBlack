...
|---|---|---|---|
| `index.html` | 853 | `<div id="ver">גרסה v28</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 101 | `console.log("… גרסה v28")` | שורת הפתיחה בקונסול |
| `index.html` | 139 | `if(served==="v28") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 141 | `el.innerHTML='גרסה v28 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v28";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v28 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
