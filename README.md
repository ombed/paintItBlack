...
|---|---|---|---|
| `index.html` | 1128 | `<div id="ver">גרסה v40</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v40")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v40") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v40 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v40";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v40 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
