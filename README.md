...
|---|---|---|---|
| `index.html` | 812 | `<div id="ver">גרסה v24</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 101 | `console.log("… גרסה v24")` | שורת הפתיחה בקונסול |
| `index.html` | 139 | `if(served==="v24") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 141 | `el.innerHTML='גרסה v24 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v24";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v24 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
