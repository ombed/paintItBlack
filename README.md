...
|---|---|---|---|
| `index.html` | 977 | `<div id="ver">גרסה v35</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 108 | `console.log("… גרסה v35")` | שורת הפתיחה בקונסול |
| `index.html` | 146 | `if(served==="v35") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 148 | `el.innerHTML='גרסה v35 · …'` | תווית האזהרה שמוצגת כשיש פער |
