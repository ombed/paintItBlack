...
|---|---|---|---|
| `index.html` | 1148 | `<div id="ver">גרסה v54</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 133 | `console.log("… גרסה v54")` | שורת הפתיחה בקונסול |
| `index.html` | 171 | `if(served==="v54") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 173 | `el.innerHTML='גרסה v54 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v54";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v54 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
