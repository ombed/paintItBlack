...
|---|---|---|---|
| `index.html` | 900 | `<div id="ver">גרסה v29</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 101 | `console.log("… גרסה v29")` | שורת הפתיחה בקונסול |
| `index.html` | 139 | `if(served==="v29") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 141 | `el.innerHTML='גרסה v29 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v29";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v29 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
