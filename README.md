...
|---|---|---|---|
| `index.html` | 1134 | `<div id="ver">גרסה v51</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v51")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v51") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v51 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v51";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v51 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
