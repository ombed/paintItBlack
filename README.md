...
|---|---|---|---|
| `index.html` | 977 | `<div id="ver">גרסה v33</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 108 | `console.log("… גרסה v33")` | שורת הפתיחה בקונסול |
| `index.html` | 146 | `if(served==="v33") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 148 | `el.innerHTML='גרסה v33 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v33";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v33 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
