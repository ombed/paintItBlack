...
|---|---|---|---|
| `index.html` | 1078 | `<div id="ver">גרסה v37</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 118 | `console.log("… גרסה v37")` | שורת הפתיחה בקונסול |
| `index.html` | 156 | `if(served==="v37") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 158 | `el.innerHTML='גרסה v37 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v37";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v37 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
