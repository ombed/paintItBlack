...
|---|---|---|---|
| `index.html` | 1071 | `<div id="ver">גרסה v36</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 118 | `console.log("… גרסה v36")` | שורת הפתיחה בקונסול |
| `index.html` | 156 | `if(served==="v36") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 158 | `el.innerHTML='גרסה v36 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v36";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v36 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
