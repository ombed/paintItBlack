...
|---|---|---|---|
| `index.html` | 1071 | `<div id="ver">גרסה v35</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 118 | `console.log("… גרסה v35")` | שורת הפתיחה בקונסול |
| `index.html` | 156 | `if(served==="v35") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 158 | `el.innerHTML='גרסה v35 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v35";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v35 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
