...
|---|---|---|---|
| `index.html` | 763 | `<div id="ver">גרסה v17</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 95 | `console.log("… גרסה v17")` | שורת הפתיחה בקונסול |
| `index.html` | 133 | `if(served==="v17") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 135 | `el.innerHTML='גרסה v17 · …'` | תווית האזהרה שמוצגת כשיש פער |
