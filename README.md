...
|---|---|---|---|
| `index.html` | 806 | `<div id="ver">גרסה v22</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 96 | `console.log("… גרסה v22")` | שורת הפתיחה בקונסול |
| `index.html` | 134 | `if(served==="v22") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 136 | `el.innerHTML='גרסה v22 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v22";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v22 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
