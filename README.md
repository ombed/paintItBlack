...
|---|---|---|---|
| `index.html` | 1133 | `<div id="ver">גרסה v48</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v48")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v48") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v48 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v48";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v48 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
