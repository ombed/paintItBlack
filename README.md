...
|---|---|---|---|
| `index.html` | 763 | `<div id="ver">גרסה v15</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 95 | `console.log("… גרסה v15")` | שורת הפתיחה בקונסול |
| `index.html` | 133 | `if(served==="v15") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 135 | `el.innerHTML='גרסה v15 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v15";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v15 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
