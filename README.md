...
|---|---|---|---|
| `index.html` | 797 | `<div id="ver">גרסה v21</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 96 | `console.log("… גרסה v21")` | שורת הפתיחה בקונסול |
| `index.html` | 134 | `if(served==="v21") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 136 | `el.innerHTML='גרסה v21 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v21";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v21 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
