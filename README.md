...
|---|---|---|---|
| `index.html` | 74 | `<div id="ver">גרסה v11</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 77 | `console.log("… גרסה v11")` | שורת הפתיחה בקונסול |
| `index.html` | 115 | `if(served==="v11") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 117 | `el.innerHTML='גרסה v11 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v11";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v11 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
