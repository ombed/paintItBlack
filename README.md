...
|---|---|---|---|
| `index.html` | 751 | `<div id="ver">גרסה v14</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 94 | `console.log("… גרסה v14")` | שורת הפתיחה בקונסול |
| `index.html` | 132 | `if(served==="v14") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 134 | `el.innerHTML='גרסה v14 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v14";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v14 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
