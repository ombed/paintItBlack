...
|---|---|---|---|
| `index.html` | 1133 | `<div id="ver">גרסה v45</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v45")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v45") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v45 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v45";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v45 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
