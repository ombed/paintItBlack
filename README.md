...
|---|---|---|---|
| `index.html` | 1101 | `<div id="ver">גרסה v38</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 118 | `console.log("… גרסה v38")` | שורת הפתיחה בקונסול |
| `index.html` | 156 | `if(served==="v38") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 158 | `el.innerHTML='גרסה v38 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v38";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v38 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
