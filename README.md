...
|---|---|---|---|
| `index.html` | 977 | `<div id="ver">גרסה v32</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 108 | `console.log("… גרסה v32")` | שורת הפתיחה בקונסול |
| `index.html` | 146 | `if(served==="v32") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 148 | `el.innerHTML='גרסה v32 · …'` | תווית האזהרה שמוצגת כשיש פער |
