...
|---|---|---|---|
| `index.html` | 797 | `<div id="ver">גרסה v19</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 96 | `console.log("… גרסה v19")` | שורת הפתיחה בקונסול |
| `index.html` | 134 | `if(served==="v19") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 136 | `el.innerHTML='גרסה v19 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v19";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v19 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
