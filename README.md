...
|---|---|---|---|
| `index.html` | 1148 | `<div id="ver">גרסה v53</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 133 | `console.log("… גרסה v53")` | שורת הפתיחה בקונסול |
| `index.html` | 171 | `if(served==="v53") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 173 | `el.innerHTML='גרסה v53 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v53";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v53 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
