...
|---|---|---|---|
| `index.html` | 1127 | `<div id="ver">גרסה v39</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 118 | `console.log("… גרסה v39")` | שורת הפתיחה בקונסול |
| `index.html` | 156 | `if(served==="v39") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 158 | `el.innerHTML='גרסה v39 · …'` | תווית האזהרה שמוצגת כשיש פער |
