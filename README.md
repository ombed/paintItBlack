...
|---|---|---|---|
| `index.html` | 900 | `<div id="ver">גרסה v30</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 101 | `console.log("… גרסה v30")` | שורת הפתיחה בקונסול |
| `index.html` | 139 | `if(served==="v30") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 141 | `el.innerHTML='גרסה v30 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v30";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v30 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
