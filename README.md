...
|---|---|---|---|
| `index.html` | 977 | `<div id="ver">גרסה v34</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 108 | `console.log("… גרסה v34")` | שורת הפתיחה בקונסול |
| `index.html` | 146 | `if(served==="v34") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 148 | `el.innerHTML='גרסה v34 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v34";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v34 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
