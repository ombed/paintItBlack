...
|---|---|---|---|
| `index.html` | 837 | `<div id="ver">גרסה v27</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 101 | `console.log("… גרסה v27")` | שורת הפתיחה בקונסול |
| `index.html` | 139 | `if(served==="v27") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 141 | `el.innerHTML='גרסה v27 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v27";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v27 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
