...
|---|---|---|---|
| `index.html` | 1141 | `<div id="ver">גרסה v53</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 126 | `console.log("… גרסה v53")` | שורת הפתיחה בקונסול |
| `index.html` | 164 | `if(served==="v53") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 166 | `el.innerHTML='גרסה v53 · …'` | תווית האזהרה שמוצגת כשיש פער |
