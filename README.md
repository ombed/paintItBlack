...
|---|---|---|---|
| `index.html` | 1133 | `<div id="ver">גרסה v44</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v44")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v44") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v44 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v44";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v44 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
