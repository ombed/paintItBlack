...
|---|---|---|---|
| `index.html` | 1125 | `<div id="ver">גרסה v39</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 120 | `console.log("… גרסה v39")` | שורת הפתיחה בקונסול |
| `index.html` | 158 | `if(served==="v39") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 160 | `el.innerHTML='גרסה v39 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v39";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v39 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
