...
|---|---|---|---|
| `index.html` | 900 | `<div id="ver">גרסה v31</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 101 | `console.log("… גרסה v31")` | שורת הפתיחה בקונסול |
| `index.html` | 139 | `if(served==="v31") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 141 | `el.innerHTML='גרסה v31 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v31";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v31 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
