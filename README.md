...
|---|---|---|---|
| `index.html` | 74 | `<div id="ver">גרסה v12</div>` | השבב התחתון — מה שנראה על המסך |
| `index.html` | 77 | `console.log("… גרסה v12")` | שורת הפתיחה בקונסול |
| `index.html` | 115 | `if(served==="v12") return;` | **בדיקת ההשוואה** מול מה שהעובד מגיש |
| `index.html` | 117 | `el.innerHTML='גרסה v12 · …'` | תווית האזהרה שמוצגת כשיש פער |
| `sw.js` | 8 | `const V="hedact-v12";` | מפתח המטמון |

מספרי השורות נכונים לגרסה v12 והם עזר בלבד — לחפש את המחרוזת, לא לסמוך
על המספר.
